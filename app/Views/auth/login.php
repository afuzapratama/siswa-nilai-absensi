...
<head>
    ...
    <meta name="description" content="Login - Sistem Penilaian Siswa">
...
<body class="h-full bg-gradient-to-br from-blue-600 via-blue-700 to-blue-900 font-sans antialiased">
    <div class="min-h-full flex flex-col justify-center py-12 sm:px-6 lg:px-8">
        ...
        <div class="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
            <div class="bg-white py-8 px-6 shadow-2xl rounded-2xl sm:px-10">
                ...
                <div class="alert-success mb-6 flex items-center gap-3" role="alert">
                ...
                <div class="alert-error mb-6 flex items-center gap-3" role="alert">
                    <svg class="w-5 h-5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <!-- Form -->
                <form action="<?= site_url('login/process') ?>" method="POST" class="space-y-6">
                    <?= csrf_field() ?>
            ...
            <p class="mt-8 text-center text-sm text-blue-200">
                &copy; <?= date('Y') ?> Sistem Penilaian Siswa
            </p>
        </div>
    </div>
